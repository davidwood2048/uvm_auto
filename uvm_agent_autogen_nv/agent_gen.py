...
uvm_file_gen('template_defines.svh', agent_name=agent_name, itf=itf, seq_name=seq_name)
uvm_file_gen('template_interface.svh', agent_name=agent_name, itf=itf, seq_name=seq_name)
uvm_file_gen('template_agent.svh', agent_name=agent_name, itf=itf, seq_name=seq_name)
uvm_file_gen('template_agent_object.svh', agent_name=agent_name, itf=itf, seq_name=seq_name)
